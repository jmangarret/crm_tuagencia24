...
$fieldInstance->name = 'origendeventa'; //Usually matches column name
$fieldInstance->table = 'vtiger_registrodeventas';
$fieldInstance->column = 'origendeventa'; //Must be lower case
$fieldInstance->label = 'Origen de la Venta'; //Upper case preceeded by LBL_
